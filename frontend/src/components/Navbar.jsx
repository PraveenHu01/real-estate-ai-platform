    ...
    <header className="sticky top-0 z-50 glass-nav">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          <Link to="/" className="flex items-center space-x-3 group">
            <div className="w-11 h-11 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center shadow-lg group-hover:scale-105 transition-transform">
      ...
      {mobileOpen && (
        <div className="lg:hidden glass-card border-t border-slate-800 px-4 pt-3 pb-6 space-y-2">
          ...
          {user?.role === 'Seller' && (
            <Link to="/add-property" onClick={() => setMobileOpen(false)} className="block py-2.5 text-sm font-medium text-blue-400">+ Add Property</Link>
          )}
          {user ? (
